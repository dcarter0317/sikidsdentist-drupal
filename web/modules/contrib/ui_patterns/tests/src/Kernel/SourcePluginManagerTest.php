...
final class SourcePluginManagerTest extends KernelTestBase {
  ...
  protected function setUp(): void {
    ...
    DeprecationHelper::backwardsCompatibleCall(\Drupal::VERSION, '11.2.0', static fn () => EntityTestHelper::createBundle('ui_patterns'), static fn () => \entity_test_create_bundle('ui_patterns'));
