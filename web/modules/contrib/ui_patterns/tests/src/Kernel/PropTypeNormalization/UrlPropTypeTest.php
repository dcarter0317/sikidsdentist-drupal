...
final class UrlPropTypeTest extends PropTypeNormalizationTestBase {
  ...
  public function testNormalizationManualData(): void {
    $tests = [
      ...
      'uri route button' => [Url::fromUri('route:<button>'), ''],
      'uri route nolink' => [Url::fromUri('route:<nolink>'), ''],
    ];
  ...
  public static function normalizationTests(): array {
    return [
      ...
      'nolink shortcut' => ['<nolink>', ''],
      'button shortcut' => ['<button>', ''],
      'route uri button' => ['route:<button>', ''],
      'route uri nolink' => ['route:<nolink>', ''],
