...
/**
 * The header area of a view display.
 */
#[Source(
  id: 'view_header',
  label: new TranslatableMarkup('[View] Header'),
  description: new TranslatableMarkup('The header area of the view display.'),
  prop_types: ['slot'],
...
class ViewHeaderSource extends ViewsDisplaySourceBase {

  /**
   * {@inheritdoc}
   */
  protected function renderFromView(ViewExecutable $view): mixed {
    return self::renderArea($view, 'header', empty($view->result));
  }
