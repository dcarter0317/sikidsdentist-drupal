...
namespace Drupal\Tests\ebt_columns\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ebt_columns'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ebt_columns']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ebt_columns');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ebt_columns'));
