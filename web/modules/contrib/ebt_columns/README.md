...
EBT Columns module provides ability to insert EBT Block.

For a full description of the module, visit the
[project page](https://www.drupal.org/project/ebt_columns).

Submit bug reports and feature suggestions, or track changes in the
[issue queue](https://www.drupal.org/project/issues/ebt_columns).
...
- If you use Field Layout module, it will automatically apply Layout Builder for
  ...
  block type fields:
  /admin/structure/block/block-content/manage/ebt_columns/display/default
