...
namespace Drupal\Tests\ept_tiles\Functional;
...
class InstallTest extends BrowserTestBase {
  ...
  public function testInstallation() {
    ...
    $this->assertFalse($this->moduleHandler->moduleExists('ept_tiles'));
    ...
    $this->assertTrue($this->moduleInstaller->install(['ept_tiles']));
    \Drupal::service('config.installer')->installDefaultConfig('module', 'ept_tiles');
    $this->reloadServices();
    $this->assertTrue($this->moduleHandler->moduleExists('ept_tiles'));
