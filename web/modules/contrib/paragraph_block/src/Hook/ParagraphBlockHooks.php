...
class ParagraphBlockHooks {
  ...
  public function entityDuplicate(EntityInterface $duplicate, EntityInterface $entity) : void {
    if (!$duplicate instanceof BlockContentInterface) {
      return;
    }
    // Duplicate paragraphs.
    if (!$duplicate->hasField(ParagraphBlockServiceInterface::FIELD_NAME)) {
      return;
    }
    $field = $duplicate->get(ParagraphBlockServiceInterface::FIELD_NAME);
