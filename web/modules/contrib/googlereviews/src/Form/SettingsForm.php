...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['google_places_api'] = [
      '#type' => 'select',
      '#title' => $this->t('Google Places API version'),
      '#default_value' => $this->config('googlereviews.settings')->get('google_places_api'),
      '#options' => [
        0 => $this->t('Legacy'),
        1 => $this->t('v1 (new)'),
      ],
    ...
    $form['google_api_url'] = [
      ...
      '#description' => $this->t('The Google Maps Places API URL (Legacy: :link0 , v1: :link1)',
      [
        ':link0' => 'https://maps.googleapis.com/maps/api/place/details/json',
        ':link1' => 'https://places.googleapis.com/v1/places/',
      ]),
      '#required' => TRUE,
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('googlereviews.settings')
      ->set('google_places_api', $form_state->getValue('google_places_api'))
